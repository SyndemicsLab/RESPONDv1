...
# Save general outputs (all compartments' sizes in each cycle), all types overdose and background mortality as csv files
...
time_varying_entering_cohort_cycles <<- c(5,7,120)    # time intervals for entering cohort. Only the upper limit is inclusive.
# overdose parameters
