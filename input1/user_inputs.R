...
input_type <<- "deterministic"     # Only for "manual" mode
...
# Aging parameters
cycles_in_age_brackets <<- 20      # number of cycles in each age bracket. With weekly cycle and 5-year age bracket: 52*5
...
time_varying_blk_trans_cycles <<- c(10) # each element should have its own matrix. Each of thses matrices represents a time interval. Only the upper limit is inclusive.
